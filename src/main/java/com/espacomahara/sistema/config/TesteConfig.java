...
public class TesteConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Pedido p1 = new Pedido(null, Instant.parse("2023-10-01T19:53:07Z"), FormaPagamento.CREDITO, u1);
		Pedido p2 = new Pedido(null, Instant.parse("2023-10-02T03:42:10Z"), FormaPagamento.DEBITO, u2);
		Pedido p3 = new Pedido(null, Instant.parse("2023-10-03T15:21:22Z"), FormaPagamento.PIX, u1);
